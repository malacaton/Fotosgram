...
export default class FileSystem {
  ...
  imagenesDeTempHaciaPost(userId: string) {
    const pathTemp = path.resolve(__dirname, '../uploads/', userId, 'temp'); // Si la barra separadora no se pone, '.resolve' ya la pone
    ...
    const imagenesTemp = this.obtenerImagenesEnTemp(pathTemp, userId);

  }

  private obtenerImagenesEnTemp(pathTemp: string, userId: string) {
